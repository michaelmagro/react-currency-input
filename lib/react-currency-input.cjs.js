...
var wrapDisplayName = function wrapDisplayName(BaseComponent, hocName) {
  return hocName + "(" + (_getDisplayName.default)(BaseComponent) + ")";
};
...
exports['default'] = {
  jss: (_propTypes.shape)({
    options: (_propTypes.shape)({
  ...
  _createClass(StyleRule, [{
    ...
    value: function toJSON() {
      ...
      for (var prop in this.style) {
        ...
        if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) !== 'object') json[prop] = value;else if (Array.isArray(value)) json[prop] = (_toCssValue2['default'])(value);
      }
      return json;
    }
...
exports['default'] = {
  onCreateRule: function onCreateRule(name, decl, options) {
    if (!(_isObservable2['default'])(decl)) return null;
...
function setProperty(cssRule, prop, value) {
  try {
    ...
    if (Array.isArray(value)) {
      cssValue = (_toCssValue2['default'])(value, true);
...
function removeProperty(cssRule, prop) {
  try {
    ...
    (_warning2['default'])(false, '[JSS] DOMException "%s" was thrown. Tried to remove property "%s".', err.message, prop);
  }
}
...
var Jss = function () {
  function Jss(options) {
    ...
    this.generateClassName = (_createGenerateClassName2['default'])();
...
function convertCase(style) {
  ...
  for (var prop in style) {
    converted[(_hyphenateStyleName2['default'])(prop)] = style[prop];
  }
...
function camelCase() {
  ...
  function onChangeValue(value, prop, rule) {
    var hyphenatedProp = (_hyphenateStyleName2['default'])(prop);
...
var _jssVendorPrefixer = interopRequireDefault(lib$5);
...
function jssPreset() {
  return {
    plugins: [(_jssGlobal.default)(), (_jssNested.default)(), (_jssCamelCase.default)(), (_jssDefaultUnit.default)(), (_jssVendorPrefixer.default)(), (_jssPropsSort.default)()]
  };
}
...
function mergeClasses() {
  ...
  return (_objectSpread2.default)({}, baseClasses, Object.keys(newClasses).reduce(function (accumulator, key) {
    process.env.NODE_ENV !== "production" ? (_warning.default)(baseClasses[key] || noBase, ["Material-UI: the key `".concat(key, "` ") + "provided to the classes property is not implemented in ".concat((_getDisplayName.default)(Component$$1), "."), "You can only override one of the following: ".concat(Object.keys(baseClasses).join(','))].join('\n')) : void 0;
    process.env.NODE_ENV !== "production" ? (_warning.default)(!newClasses[key] || typeof newClasses[key] === 'string', ["Material-UI: the key `".concat(key, "` ") + "provided to the classes property is not valid for ".concat((_getDisplayName.default)(Component$$1), "."), "You need to provide a non empty string instead of: ".concat(newClasses[key], ".")].join('\n')) : void 0;
...
function createBreakpoints(breakpoints) {
  var _breakpoints$values = breakpoints.values,
    ...
    xl: 1920
      ...
      other = (_objectWithoutProperties2.default)(breakpoints, ["values", "unit", "step"]);
...
function createMixins(breakpoints, spacing, mixins) {
  ...
  return (_objectSpread3.default)({
    gutters: function gutters() {
      var styles = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      return (_objectSpread3.default)({
        paddingLeft: spacing.unit * 2,
        paddingRight: spacing.unit * 2
      }, styles, (_defineProperty2.default)({}, breakpoints.up('sm'), (_objectSpread3.default)({
...
function clamp(value) {
  ...
  process.env.NODE_ENV !== "production" ? (_warning.default)(value >= min && value <= max, "Material-UI: the value provided ".concat(value, " is out of range [").concat(min, ", ").concat(max, "].")) : void 0;
...
function fade(color, value) {
  process.env.NODE_ENV !== "production" ? (_warning.default)(color, "Material-UI: missing color argument in fade(".concat(color, ", ").concat(value, ").")) : void 0;
...
function darken(color, coefficient) {
  process.env.NODE_ENV !== "production" ? (_warning.default)(color, "Material-UI: missing color argument in darken(".concat(color, ", ").concat(coefficient, ").")) : void 0;
  if (!color) return color;
  color = decomposeColor(color);
...
function lighten(color, coefficient) {
  process.env.NODE_ENV !== "production" ? (_warning.default)(color, "Material-UI: missing color argument in lighten(".concat(color, ", ").concat(coefficient, ").")) : void 0;
  if (!color) return color;
  color = decomposeColor(color);
  coefficient = clamp(coefficient);
...
var require$$3$1 = ( es$1 && deepmerge_1 ) || es$1;
...
var _deepmerge = interopRequireDefault(require$$3$1);
...
function addLightOrDark(intent, direction, shade, tonalOffset) {
  if (!intent[direction]) {
    if (intent.hasOwnProperty(shade)) {
      ...
      intent.light = (_colorManipulator.lighten)(intent.main, tonalOffset);
    } else if (direction === 'dark') {
      intent.dark = (_colorManipulator.darken)(intent.main, tonalOffset * 1.5);
    }
  }
}
...
function createPalette(palette) {
  var _palette$primary = palette.primary,
    ...
    dark: _red.default[700]
      ...
      other = (_objectWithoutProperties2.default)(palette, ["primary", "secondary", "error", "type", "contrastThreshold", "tonalOffset"]);
  ...
  function getContrastText(background) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      ...
      process.env.NODE_ENV !== "production" ? (_warning.default)(contrast >= 3, ["Material-UI: the contrast ratio of ".concat(contrast, ":1 for ").concat(contrastText, " on ").concat(background), 'falls below the WACG recommended absolute minimum contrast ratio of 3:1.', 'https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast'].join('\n')) : void 0;
    }
  ...
  process.env.NODE_ENV !== "production" ? (_warning.default)(types[type], "Material-UI: the palette type `".concat(type, "` is not supported.")) : void 0;
  var paletteOutput = (_deepmerge.default)((_objectSpread2.default)({
...
function createTypography(palette, typography) {
  var _ref = typeof typography === 'function' ? typography(palette) : typography,
      ...
      other = (_objectWithoutProperties2.default)(_ref, ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "htmlFontSize", "allVariants"]);
  ...
  return (_deepmerge.default)({
    ...
    display4: (_objectSpread2.default)({
    ...
    display3: (_objectSpread2.default)({
      fontSize: pxToRem(56),
    ...
    display2: (_objectSpread2.default)({
      fontSize: pxToRem(45),
      fontWeight: fontWeightRegular,
      fontFamily: fontFamily,
    ...
    display1: (_objectSpread2.default)({
      fontSize: pxToRem(34),
      fontWeight: fontWeightRegular,
      fontFamily: fontFamily,
    ...
    headline: (_objectSpread2.default)({
      fontSize: pxToRem(24),
      fontWeight: fontWeightRegular,
      fontFamily: fontFamily,
    ...
    subheading: (_objectSpread2.default)({
      fontSize: pxToRem(16),
      fontWeight: fontWeightRegular,
      fontFamily: fontFamily,
    ...
    caption: (_objectSpread2.default)({
      fontSize: pxToRem(12),
      fontWeight: fontWeightRegular,
      fontFamily: fontFamily,
  ...
  create: function create() {
    ...
    return function () {
      var _options$duration = options.duration,
          ...
          other = (_objectWithoutProperties2.default)(options, ["duration", "easing", "delay"]);
      process.env.NODE_ENV !== "production" ? (_warning.default)(isString(props) || Array.isArray(props), 'Material-UI: argument "props" must be a string or Array.') : void 0;
      process.env.NODE_ENV !== "production" ? (_warning.default)(isNumber(durationOption) || isString(durationOption), "Material-UI: argument \"duration\" must be a number or a string but found ".concat(durationOption, ".")) : void 0;
      process.env.NODE_ENV !== "production" ? (_warning.default)(isString(easingOption), 'Material-UI: argument "easing" must be a string.') : void 0;
      process.env.NODE_ENV !== "production" ? (_warning.default)(isNumber(delay) || isString(delay), 'Material-UI: argument "delay" must be a number or a string.') : void 0;
      process.env.NODE_ENV !== "production" ? (_warning.default)(Object.keys(other).length === 0, "Material-UI: unrecognized argument(s) [".concat(Object.keys(other).join(','), "]")) : void 0;
...
function createMuiTheme() {
  ...
  var _options$breakpoints = options.breakpoints,
      ...
      other = (_objectWithoutProperties2.default)(options, ["breakpoints", "mixins", "palette", "shadows", "typography"]);
  var palette = (_createPalette.default)(paletteInput);
  var breakpoints = (_createBreakpoints.default)(breakpointsInput);
  var muiTheme = (_objectSpread2.default)({
    breakpoints: breakpoints,
    direction: 'ltr',
    mixins: (_createMixins.default)(breakpoints, _spacing.default, mixinsInput),
    overrides: {},
    ...
    typography: (_createTypography.default)(palette, typographyInput)
  }, (_deepmerge.default)({
  ...
  process.env.NODE_ENV !== "production" ? (_warning.default)(muiTheme.shadows.length === 25, 'Material-UI: the shadows array provided to createMuiTheme should support 25 elevations.') : void 0;
  return muiTheme;
}
...
var themeListener = {
  contextTypes: (_defineProperty2.default)({}, CHANNEL, _propTypes.default.object),
...
function safePrefix(classNamePrefix) {
  ...
  process.env.NODE_ENV !== "production" ? (_warning.default)(prefix.length < 256, "Material-UI: the class name prefix is too long: ".concat(prefix, ".")) : void 0; // Sanitize the string as will be used to prefix the generated class name.
...
function createGenerateClassName() {
  ...
  return function (rule, styleSheet) {
    ruleCounter += 1;
    process.env.NODE_ENV !== "production" ? (_warning.default)(ruleCounter < 1e10, ['Material-UI: you might have a memory leak.', 'The ruleCounter is not supposed to grow that much.'].join('')) : void 0; // Code branch the whole block at the expense of more code.
...
function getStylesCreator(stylesOrCreator) {
  ...
  process.env.NODE_ENV !== "production" ? (_warning.default)((_typeof2.default)(stylesOrCreator) === 'object' || themingEnabled, ['Material-UI: the first argument provided to withStyles() is invalid.', 'You need to provide a function generating the styles or a styles object.'].join('\n')) : void 0;
  ...
  function create(theme, name) {
    ...
    var stylesWithOverrides = (_objectSpread2.default)({}, styles);
    Object.keys(overrides).forEach(function (key) {
      process.env.NODE_ENV !== "production" ? (_warning.default)(stylesWithOverrides[key], ['Material-UI: you are trying to override a style that does not exist.', "Fix the `".concat(key, "` key of `theme.overrides.").concat(name, "`.")].join('\n')) : void 0;
      stylesWithOverrides[key] = (_deepmerge.default)(stylesWithOverrides[key], overrides[key], {
...
var jss = (_jss.create)((_jssPreset.default)()); // Use a singleton or the provided one by the context.

var generateClassName = (_createGenerateClassName.default)(); // Global index counter to preserve source order.
...
function getDefaultTheme() {
  ...
  defaultTheme = (_createMuiTheme.default)();
  return defaultTheme;
...
var withStyles = function withStyles(stylesOrCreator) {
  ...
  return function (Component$$1) {
    var _options$withTheme = options.withTheme,
        ...
        name = options.name,
        styleSheetOptions = (_objectWithoutProperties2.default)(options, ["withTheme", "flip", "name"]);
    var stylesCreator = (_getStylesCreator.default)(stylesOrCreator);
    var listenToTheme = stylesCreator.themingEnabled || withTheme || typeof name === 'string';
    indexCounter += 1;
    stylesCreator.options.index = indexCounter;
    process.env.NODE_ENV !== "production" ? (_warning.default)(indexCounter < 0, ['Material-UI: you might have a memory leak.', 'The indexCounter is not supposed to grow that much.'].join(' ')) : void 0;

    var WithStyles =
    /*#__PURE__*/
    function (_React$Component) {
      (_inherits2.default)(WithStyles, _React$Component);

      function WithStyles(props, context) {
        var _this;

        (_classCallCheck2.default)(this, WithStyles);
        _this = (_possibleConstructorReturn2.default)(this, (WithStyles.__proto__ || Object.getPrototypeOf(WithStyles)).call(this, props, context));
        ...
        _this.sheetOptions = (_objectSpread2.default)({
          generateClassName: generateClassName
      ...
      (_createClass2.default)(WithStyles, [{
        ...
        value: function getClasses() {
          ...
          if (generate) {
            this.cacheClasses.value = (_mergeClasses.default)({
        ...
        value: function attach(theme) {
          ...
          if (sheetManagerTheme.refs === 0) {
            ...
            if (process.env.NODE_ENV !== 'production' && !meta) {
              meta = (_getDisplayName.default)(Component$$1);
              process.env.NODE_ENV !== "production" ? (_warning.default)(typeof meta === 'string', ['Material-UI: the component displayName is invalid. It needs to be a string.', "Please fix the following component: ".concat(Component$$1, ".")].join('\n')) : void 0;
            }

            var sheet = this.jss.createStyleSheet(styles, (_objectSpread2.default)({
              meta: meta,
        ...
        value: function render() {
          var _props = this.props,
              ...
              other = (_objectWithoutProperties2.default)(_props, ["classes", "innerRef"]);
          var more = (_getThemeProps.default)({
            theme: this.theme,
            name: name
          ...
          return _react.default.createElement(Component$$1, (_extends2.default)({}, more, {
    ...
    WithStyles.contextTypes = (_objectSpread2.default)({
      muiThemeProviderOptions: _propTypes.default.object
    }, _contextTypes.default, listenToTheme ? _themeListener.default.contextTypes : {});

    if (process.env.NODE_ENV !== 'production') {
      WithStyles.displayName = (_wrapDisplayName.default)(Component$$1, 'WithStyles');
    }

    (_hoistNonReactStatics.default)(WithStyles, Component$$1);
...
var React$$2 = _interopDefault(React__default);
var PropTypes$$2 = _interopDefault(PropTypes);
...
EventListener.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  target: PropTypes$$2.oneOfType([PropTypes$$2.object, PropTypes$$2.string]).isRequired
} : {};
...
/*#__PURE__*/
function (_React$Component) {
  (_inherits2.default)(Textarea, _React$Component);

  // Corresponds to 10 frames at 60 Hz.
  function Textarea(props) {
    var _this;

    (_classCallCheck2.default)(this, Textarea);
    _this = (_possibleConstructorReturn2.default)(this, (Textarea.__proto__ || Object.getPrototypeOf(Textarea)).call(this));
    _this.isControlled = null;
    _this.shadowRef = null;
    _this.singlelineShadowRef = null;
    _this.inputRef = null;
    _this.value = null;
    _this.handleResize = (_debounce.default)(function () {
  ...
  (_createClass2.default)(Textarea, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function render() {
      var _props = this.props,
          ...
          value = _props.value,
          other = (_objectWithoutProperties2.default)(_props, ["classes", "className", "defaultValue", "onChange", "rows", "rowsMax", "textareaRef", "value"]);
      return _react.default.createElement("div", {
        ...
        "aria-hidden": "true",
        className: (_classnames.default)(classes.textarea, classes.shadow),
        readOnly: true,
        ...
        tabIndex: -1,
        value: value
      }), _react.default.createElement("textarea", (_extends2.default)({
        rows: rows,
        className: (_classnames.default)(classes.textarea, className),
        defaultValue: defaultValue,
        value: value,
...
var _default = (_withStyles.default)(styles)(Textarea);
...
/*#__PURE__*/
function (_React$Component) {
  (_inherits2.default)(Input, _React$Component);

  // Holds the input reference
  function Input(props, context) {
    var _this;

    (_classCallCheck2.default)(this, Input);
    _this = (_possibleConstructorReturn2.default)(this, (Input.__proto__ || Object.getPrototypeOf(Input)).call(this, props, context));
    _this.isControlled = null;
    _this.input = null;
    _this.state = {
      focused: false
  ...
  (_createClass2.default)(Input, [{
    ...
    value: function render() {
      ...
      var inputPropsClassName = _props$inputProps.className,
          inputPropsProp = (_objectWithoutProperties2.default)(_props$inputProps, ["className"]),
      ...
      return _react.default.createElement("div", (_extends2.default)({
        className: className
      }, other), startAdornment, _react.default.createElement(InputComponent, (_extends2.default)({
        "aria-invalid": error,
...
var _default = (_withStyles.default)(styles, {
  name: 'MuiInput'
})(Input);
